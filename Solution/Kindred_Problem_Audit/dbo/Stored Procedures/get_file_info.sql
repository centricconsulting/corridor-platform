...
--  of source columns
DECLARE @linkedServerName sysname = 'TempKindredAuditExcelTEST'
...
SELECT * INTO tmp.SheetInfo FROM OPENROWSET('SQLNCLI', 'Server=(local);Trusted_Connection=yes;','EXEC sp_tables_ex TempKindredAuditExcelTEST');
