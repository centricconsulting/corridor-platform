CREATE TABLE [sfc].[agency_location]
(
  ...
  CONSTRAINT [sfc_agency_location_pk] PRIMARY KEY CLUSTERED ([agency_location_uid] ASC)

);
GO

CREATE UNIQUE INDEX [sfc_agency_location_u1] ON [sfc].[agency_location] ([agency_location],[agency_company],[agency_status])
GO
