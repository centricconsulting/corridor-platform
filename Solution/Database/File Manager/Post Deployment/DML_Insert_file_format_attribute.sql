...
, (N'HCHB.1.0', N'Agency Location', 3, '^([\w]{0,3})',1,1, GETDATE(), GETDATE(), 0)
, (N'HCHB.1.0', N'Agency Location Alias', 3, '^([\w]{0,3})',1,1, GETDATE(), GETDATE(), 0)
...
, (N'HCHB.1.0', N'OASIS Visit Type', 8, NULL,1,1, GETDATE(), GETDATE(), 0)
